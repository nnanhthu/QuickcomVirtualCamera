...
namespace CMIO { namespace DPA { namespace Sample { namespace Server
{
	...
	// VCamAssistant()
	//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	VCamAssistant::VCamAssistant(int type) :
        Assistant()
	{
        CreateDevices(type);
	}
    ...
    // Instance()
    //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    VCamAssistant* VCamAssistant::Instance(int type)
    {
        if (!sInstance) {
            sInstance = new VCamAssistant(type);
        }
    ...
    // CreateDevices()
    //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    void VCamAssistant::CreateDevices(int type)
    {
        ...
        VCamDevice* device = new VCamDevice(type);
